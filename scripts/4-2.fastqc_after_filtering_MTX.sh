...
# Set parameters.
BASE=~/crisprome/hmp
#INPUT_DIR=${BASE}/intermediates/3.fastp/MTX
INPUT_DIR=${BASE}/intermediates/3.fastp/nat_microbiol_MTX
...
OUTPUT_DIR=${BASE}/intermediates/4.fastqc_after_filtering/MTX_new
OUTPUT_DIR=${BASE}/intermediates/4.fastqc_after_filtering/nat_microbiol_MTX
