...
############################################################################################################################################
# Script: ~/crisprome/hmp/scripts/2.fastqc_before_filtering.sh
...
# Set parameters.
BASE=~/crisprome/hmp
INPUT_DIR=~/public_raw_data/hmp2/IBDMDB/nonIBD
INPUT_LIST=~/crisprome/hmp/intermediates/1.dataset_summary/1-7.Nat_Microbiol_nonIBD_metadata.txt
OUTPUT_DIR=${BASE}/intermediates/2.fastqc_before_filtering
